            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0 mt-1">Criar Convidado</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control" placeholder="emal@company.com" v-model="formConvidados.email" :class="{'is-invalid' : formConvidados.errors.has('email')}">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <button class="btn btn-danger" type="button" role="button" :disabled="formConvidados.busy">Cancelar</button>
                            <button class="btn btn-success" type="button" role="button" @click.prevent="salvarConvidado" :disabled="formConvidados.busy">Salvar</button>
                        </div>
                    </div>
                </div>
            </div>
